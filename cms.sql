...
--
-- Host: localhost
-- Generation Time: Jan 26, 2021 at 01:45 PM
...
CREATE TABLE `articles` (
  ...
  `article_title` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'Test Post2as', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 1611647822),
(7, 'Test Post4', 'Hello', 1611648718),
(10, 'Kelias i nezinias', 'lorem', 1611648941);
